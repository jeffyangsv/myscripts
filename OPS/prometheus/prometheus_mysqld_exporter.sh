#/bin/bash
##################################################
#Name:        prometheus_mysql_exporter.sh
#Version:     v0.9.0
#Create_Date: 2017-2-23
#Author:      GuoLikai(glk73748196@sina.com)
#Description: "Prometheus源码Go语言编写,可直接启动"
#Note: 	      "mysqld_exporter需要连接到Mysql权限"
##################################################

App=mysqld_exporter-0.9.0.linux-amd64
...
fpid()
{
    AppMasterPid=$(ps ax | grep "mysqld_exporter" | grep -v "grep" | awk '{print $1}' 2> /dev/null)
}
